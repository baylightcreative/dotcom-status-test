...
(function($) {
  $.expander = {
    ...
    defaults: {
      ...
      expandText: 'show more <span style="font-size:9px; line-height:14px;">&#9660;</span>',
      expandPrefix: '&hellip; ',
      ...
      userCollapseText: 'show less <span style="font-size:9px; line-height:14px;">&#9650;</span>',
      userCollapsePrefix: ' ',
  ...
  $.fn.expander = function(options) {
      ...
      init: function() {
        this.each(function() {
          ...
          if ( o.userCollapse && !$this.find('span.' + o.lessClass).length ) {
            $this
            .find(detailSelector)
            .append('<span class="' + o.lessClass + '">' + o.userCollapsePrefix + '<a class="read_more_button" href="#">' + o.userCollapseText + '</a></span>');
          }
    ...
    function buildMoreLabel(o) {
      ...
      ret += '<a class="read_more_button" href="#">' + o.expandText + '</a></span>';
      return ret;
    }
